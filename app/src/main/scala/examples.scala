...
//import hocki.klocki.typing.{SchemaTy, addDimSchema, inferTypes, removeDimSchema, unionSchema}
//
...
//
//@main
//def chainedDimensionIntroductionsExample: SchemaTy =
...
//
//@main
//def parallelDimensionRemovalExample: SchemaTy =
...
//  inferTypes(schema, typing)(using schemata)
//
//def funnySchema: (BlockSchema, mutable.Map[BlockSchemaId, SchemaTy], Map[BlockSchemaId, BlockSchema]) =
//  val dim_a = Dim("a")
//  val dim_b = Dim("b")
//
//  val x0 = DimSetVar("X_0")
...
//
//@main
//def funnySchemaExample: SchemaTy =
//  val (schema, typing, schemata) = funnySchema
//  inferTypes(schema, typing)(using schemata)
//
//@main
//def funnySchemaSequential: SchemaTy =
...
//
//@main
//def funnySchemaExampleParallel: SchemaTy =
//  val (funny_schema, funny_typing, innerSchemata) = funnySchema
...
//
//@main
//def minimalistExample: SchemaTy =
//  val x0 = DimSetVar("X_0")
//  val x1 = DimSetVar("X_1")
//
//  val y = DimSetVar("Y")
